        ...
        <>
          {isMobileDevice ?
            <div className='flex-container'>
              <p className='red flex-content' onClick={toggleHomePage}>go to model --&#62;</p>
              <p className='red flex-content'>36% of 1.8 trillion stars</p>
            </div>
            :
            <div className='flex-container'>
              <p className='red flex-content' onClick={toggleHomePage}>go to model --&#62;</p>
          ...
          {isMobileDevice ?
            <div className='flex-row'>
              <div className='flex-column'>
                <a href='https://github.com/hamishmcdonald' target='_blank'>
                ...
                <a href='https://twitter.com/hamushmcdonald?t=UfIBZ05e6F9Ce9af_mE8Xw&s=09' target='_blank'>
                  <p className='red flex-content'>X/Twitter --&#62;</p>
                </a>
              </div>
              <div className='flex-column'>
                ...
                <a href='' target='_blank'>
                  <p className='red flex-content'>Curriculum Vitae --&#62;</p>
                </a>
              </div>
            </div>
            :
            <div className='flex-container'>
              ...
              <a href='https://twitter.com/hamushmcdonald?t=UfIBZ05e6F9Ce9af_mE8Xw&s=09' target='_blank'>
                <p className='red flex-content'>Twitter --&#62;</p>
              </a>
              <a href='mailto:hamishwmcd@gmail.com' target='_blank'>
                <p className='red flex-content'>Email --&#62;</p>
              </a>
          ...
          <h2>Projects</h2>
          <a href='https://github.com/hamishmcdonald/hamish-mcdonald-portfolio' target='_blank'>
            <h3>hamish-mcdonald-portfolio --&#62;</h3>
          </a>
          <p>A one-pager built with React to showcase my work as a software developer. </p>

          <a href='https://greekonsoul.com' target='_blank'>
            <h3>greek-on-soul --&#62;</h3>
          </a>
          <p>
          ...
          <a href='https://github.com/hamishmcdonald/galaxy-las' target='_blank'>
            <h3>galaxy-las --&#62;</h3>
          </a>
          <p>
          ...
          The fourth formula is Wein's law which describes the relationship between emission spectrum of a black body and its 
          ...
          <p className='red copyright'>&copy;2023 by Hamish McDonald</p>
        </>
        :
        <>
          {isMobileDevice ?
            <div className='flex-container'>
              <p className='red flex-content' onClick={toggleHomePage}>&#60;-- back to home</p>
              <p className='red flex-content'>36% of 1.8 trillion stars</p>
            </div>
            :
            <div className='flex-container'>
