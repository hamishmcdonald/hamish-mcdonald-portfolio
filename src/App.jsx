...
function App() {
  ...
  return (
    <>
      ...
      <img src='GreekOnSoulWebsite2.jpg' className='image-content'></img>
      <p>
      ...
      <p className='tenure'>March 2023-June 2023</p>
      <ul>
      ...
      <ul>
        <li>Provided excellent customer service to guests, processed check-ins and check-outs, and managed customer accounts.
        </li>
      </ul>
      
      <h4>Business Manager/Labourer at Endeavour Products and Equipment - Paddington, Northgate, The Gap</h4>
      <p className='tenure'>October 2021 - October 2022</p>
      <ul>
        <li>Managed a Google business profile, planned, built and demolished simple structures.</li>
      </ul>

      <h4>Team Member at Grill'd Healthy Burgers - Brisbane CBD</h4>
      <p className='tenure'>November 2019 - November 2021</p>
      <ul>
        <li>Prepared and served food, took orders, cleared tables, and ensured customer satisfaction.</li>
      </ul>
      
      <h4>Food Service Team Member at KFC - Kelvin Grove</h4>
      <p className='tenure'>November 2018 - November 2019</p>
      <ul>
        <li>Prepared and cooked food, cleaned kitchen equipment, and followed safety procedures.</li>
      </ul>
      ...
      <p className='red copyright'>&copy;2023 by Hamish McDonald - personal referees available upon request</p>
    </>
  )
}
